public class Main {
    public static void main(String[] args) {
        ...
        Pokemon bulbasaur = new Pokemon("Bulbasaur", Type.GRASS, 200, 49, 49);
        bulbasaur.addMove(new Move("Vine Whip", Type.GRASS, 45));
        bulbasaur.addMove(new Move("Tackle", Type.NORMAL, 40));

        BattleMechanism battleMechanism = new BattleMechanism(pikachu, bulbasaur);
        battleMechanism.start();
    }
}